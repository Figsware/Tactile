...
namespace Tactile.Gadgets
{
    ...
    [AddComponentMenu("Tactile/Gadgets/Selectable Utility")]
    public class SelectableUtility : MonoBehaviour
    {
        ...
        /// <param name="noFade">Whether to set the color immediately</param>
        private void SetColorBlock(ColorBlock block, bool noFade = false)
        {
            GetSelectable().colors = block;
            if (gameObject.activeInHierarchy && noFade)
